...
const Forgot = lazy(() => import(/*webpackChunkName:'forgot'*/ './user/forgot'));
const Write = lazy(() => import(/*webpackChunkName:'write', webpackPrefetch:true*/ './write'));
const PostTable = lazy(() => import(/*webpackChunkName:'post-table'*/ './manage/post-table'));
const Chart = lazy(() => import(/*webpackChunkName:'chart',webpackPrefetch:true*/ './manage/chart'));
const CommentTable = lazy(() => import(/*webpackChunkName:'comment-table'*/ './manage/comment-table'));
const Profile = lazy(() => import(/*webpackChunkName:'profile'*/ './manage/profile'));
const RoleTable = lazy(() => import(/*webpackChunkName:'role-page'*/ './manage/role-table'));
const RoleEdit = lazy(() => import(/*webpackChunkName:'role-page'*/ './manage/role-edit'));
const Sysparam = lazy(() => import(/*webpackChunkName:'sysparam'*/ './manage/sysparam'));
const PermissionTable = lazy(() => import(/*webpackChunkName:'permission-page'*/ './manage/permission-table'));
