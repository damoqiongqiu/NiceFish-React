...
function Chart() {
    ...
    series: [
      {
        ...
        itemStyle: {
          normal: {
            color: (params: any) => {
              const color = Color.genColor(barChart.series[0].data);
              return color[params.dataIndex];
            },
          },
        },
        data: [
          900, 1258, 1300, 1334, 1390, 1430, 1520, 1000, 500, 444, 999, 555,
        ],
      },
    ],
  };
  ...
  useEffect(() => {
    pieEchart = echarts.init(pie.current as any);
    barEchart = echarts.init(bar.current as any);
    lineEchart = echarts.init(line.current as any);
    pieEchart.setOption(pieChart);
    barEchart.setOption(barChart);
    lineEchart.setOption(lineChart);
  });
  return (
    <div>
      <div ref={pie} className="react-echart" />
      <div ref={bar} className="react-echart" />
      <div ref={line} className="react-echart" />
    </div>
  );
}
