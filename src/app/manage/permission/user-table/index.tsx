...
const UserTable = () => {
  const columns = [
    ...
    },
    {
      ...
      sorter: (a: any, b: any) => new Date(a.registerTime).getTime() - new Date(b.registerTime).getTime()
    },
    {
      title: '最后登录',
      dataIndex: 'lastLoginTime',
      sorter: (a: any, b: any) => new Date(a.lastLoginTime).getTime() - new Date(b.lastLoginTime).getTime()
    },
    {
      title: '操作',
      dataIndex: 'options',
        ...
        <div className="row">
          <div className="col-sm-8">
            <div className="input-group">
              <input className="form-control" type="text" placeholder="用户名，昵称" />
