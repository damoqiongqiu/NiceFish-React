        ...
        <div className="pd-10px md-text-align-right">
          <form role="form">
            <div className="form-group row">
              <label className="col-md-5 col-form-label">文章列表显示条数：</label>
              <div className="col-md-7">
                <input type="text" required className="form-control" placeholder="文章列表显示条数" />
              </div>
            </div>
            <div className="form-group row">
              <label className="col-md-5 col-form-label">文章标题最小长度：</label>
              <div className="col-md-7">
                <input type="text" required className="form-control" placeholder="文章标题最小长度" />
              </div>
            </div>
            <div className="form-group row">
              <label className="col-md-5 col-form-label">文章标题最大长度：</label>
              <div className="col-md-7">
                <input type="text" required className="form-control" placeholder="文章标题最大长度" />
              </div>
            </div>
            <div className="form-group row">
              <label className="col-md-5 col-form-label">每日发文数量限制：</label>
              <div className="col-md-7">
      ...
      <div className="card mt-16px">
        ...
        <div className="pd-10px md-text-align-right">
          <form role="form">
            ...
            <div className="form-group row">
              <label className="col-md-5 col-form-label">评论列表每页显示条数：</label>
              <div className="col-md-7">
                <input type="text" required className="form-control" placeholder="评论列表每页显示条数" />
              </div>
            </div>
            <div className="form-group row">
              <label className="col-md-5 col-form-label">评论时间间隔（分钟）：</label>
              <div className="col-md-7">
      ...
      <div className="card mt-16px">
        ...
        <div className="pd-10px md-text-align-right">
          <form role="form">
            ...
            <div className="form-group row">
              <label className="col-md-5 col-form-label">个人简介最大长度：</label>
              <div className="col-md-7">
                <input type="text" required className="form-control" placeholder="个人简介最大长度" />
              </div>
            </div>
            <div className="form-group row">
              <label className="col-md-5 col-form-label">新用户禁言时间（5'）：</label>
              <div className="col-md-7">
                <input type="text" required className="form-control" placeholder="新用户自动禁言时间（5分钟）" />
              </div>
            </div>
          </form>
        </div>
